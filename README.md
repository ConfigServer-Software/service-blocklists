...
🕙 `Last Sync: 05/12/2026 18:07 UTC`
...
|--------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------|----------------------------------------------------------------|
| [Master Blocklist](https://blocklist.configserver.dev/master.ipset)      | <sub>Abusive IP addresses which have been reported for port scanning and SSH brute-forcing. HIGHLY recommended. <br> <sub><sup>Includes [AbuseIPDB](https://www.abuseipdb.com/), [IPThreat](https://ipthreat.net/), [CinsScore](https://cinsscore.com), [GreensNow](https://blocklist.greensnow.co/greensnow.txt)</sup></sub> | ★★★★★    | [view](https://blocklist.configserver.dev/master.ipset)        |
| [High Risk Networks](https://blocklist.configserver.dev/highrisk.ipset)  | <sub>Networks identified engaging in malicious activity such as port scanning, SSH/SFTP brute-force attempts, and probing web servers with common sensitive filenames (e.g. .env) in an attempt to discover exposed private data. Confidence: 100% </sub>                                                                     | ★★★★★    | [view](https://blocklist.configserver.dev/highrisk.ipset)      |
| [Bogon Networks](https://blocklist.configserver.dev/bogon.ipset)         | <sub>Unroutable, reserved, or unallocated IP ranges that should not appear on the public internet. Often used for spoofing or misconfigured traffic. </sub>                                                                                                                                                                   | ★★⚝⚝⚝    | [view](https://blocklist.configserver.dev/bogon.ipset)         |
| [Tor Exit Nodes](https://blocklist.configserver.dev/tor_exitnodes.ipset) | <sub>Public exit points of the Tor network used for anonymized traffic routing. Commonly associated with privacy usage, but also frequently used for abuse and automated attacks. </sub>                                                                                                                                      | ★★★⚝⚝    | [view](https://blocklist.configserver.dev/tor_exitnodes.ipset) |
...
| Set                                                                    | Description                                                | Severity | View                                                           |
|------------------------------------------------------------------------|------------------------------------------------------------|----------|----------------------------------------------------------------|
| [Forum Spammers](https://blocklist.configserver.dev/spam/forums.ipset) | <sub>List of known forum / blog spammers and bots</sub>    | ★★★⚝⚝    | [view](https://blocklist.configserver.dev/spam/forums.ipset)   |
| [Spamhaus](https://blocklist.configserver.dev/spam/spamhaus.ipset)     | <sub>Bad actor IP addresses registered with Spamhaus</sub> | ★★★★⚝    | [view](https://blocklist.configserver.dev/spam/spamhaus.ipset) |
...
| Set                                                                                                                     | Description                                                                                             | Severity | View                                                                                  |
|-------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------|----------|---------------------------------------------------------------------------------------|
| [AOL](https://blocklist.configserver.dev/isp/aol.ipset)                                                                 | IP ranges associated with AOL residential and legacy internet service infrastructure.                   | ★★⚝⚝⚝    | [view](https://blocklist.configserver.dev/isp/aol.ipset)                              |
| [AT&T](https://blocklist.configserver.dev/isp/att.ipset)                                                                | Residential, wireless, and broadband IP ranges operated by AT&T internet services.                      | ★★★⚝⚝    | [view](https://blocklist.configserver.dev/isp/att.ipset)                              |
| [Cablevision](https://blocklist.configserver.dev/isp/cablevision.ipset)                                                 | Customer broadband networks and infrastructure historically associated with Cablevision services.       | ★★⚝⚝⚝    | [view](https://blocklist.configserver.dev/isp/cablevision.ipset)                      |
| [Charter / Spectrum / Time Warner Cable](https://blocklist.configserver.dev/isp/charter_spectrum_timewarnercable.ipset) | Consumer and business broadband IP ranges operated by Charter Communications and Spectrum services.     | ★★★⚝⚝    | [view](https://blocklist.configserver.dev/isp/charter_spectrum_timewarnercable.ipset) |
| [Comcast](https://blocklist.configserver.dev/isp/comcast.ipset)                                                         | Residential and commercial Comcast Xfinity broadband subscriber networks and infrastructure.            | ★★★⚝⚝    | [view](https://blocklist.configserver.dev/isp/comcast.ipset)                          |
| [Cox Communications](https://blocklist.configserver.dev/isp/cox_communications.ipset)                                   | Broadband customer IP ranges and network infrastructure operated by Cox Communications.                 | ★★⚝⚝⚝    | [view](https://blocklist.configserver.dev/isp/cox_communications.ipset)               |
| [Embarq](https://blocklist.configserver.dev/isp/embarq.ipset)                                                           | Legacy telecommunications and broadband infrastructure formerly operated under Embarq networks.         | ★⚝⚝⚝⚝    | [view](https://blocklist.configserver.dev/isp/embarq.ipset)                           |
| [Frontier Communications](https://blocklist.configserver.dev/isp/frontier_communications.ipset)                         | Consumer and enterprise broadband infrastructure operated by Frontier Communications.                   | ★★⚝⚝⚝    | [view](https://blocklist.configserver.dev/isp/frontier_communications.ipset)          |
| [Qwest](https://blocklist.configserver.dev/isp/qwest.ipset)                                                             | Legacy Qwest broadband and telecommunications IP address ranges.                                        | ★⚝⚝⚝⚝    | [view](https://blocklist.configserver.dev/isp/qwest.ipset)                            |
| [Qwest / CenturyLink](https://blocklist.configserver.dev/isp/qwest_centurylink.ipset)                                   | Residential and business internet infrastructure associated with CenturyLink and legacy Qwest services. | ★★⚝⚝⚝    | [view](https://blocklist.configserver.dev/isp/qwest_centurylink.ipset)                |
| [SpaceX Starlink](https://blocklist.configserver.dev/isp/spacex_starlink.ipset)                                         | Satellite-based broadband subscriber networks operated through the Starlink internet service.           | ★★★⚝⚝    | [view](https://blocklist.configserver.dev/isp/spacex_starlink.ipset)                  |
| [Sprint](https://blocklist.configserver.dev/isp/sprint.ipset)                                                           | Legacy mobile carrier and wireless broadband IP infrastructure associated with Sprint networks.         | ★★⚝⚝⚝    | [view](https://blocklist.configserver.dev/isp/sprint.ipset)                           |
| [Suddenlink / Altice / Optimum](https://blocklist.configserver.dev/isp/suddenlink_altice_optimum.ipset)                 | Broadband subscriber and network infrastructure operated under Altice and Optimum services.             | ★★⚝⚝⚝    | [view](https://blocklist.configserver.dev/isp/suddenlink_altice_optimum.ipset)        |
| [Verizon](https://blocklist.configserver.dev/isp/verizon.ipset)                                                         | Residential, mobile, and enterprise internet infrastructure operated by Verizon Communications.         | ★★★⚝⚝    | [view](https://blocklist.configserver.dev/isp/verizon.ipset)                          |
...
|---------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------|----------|-------------------------------------------------------------------------|-------------------------------------|
| [Transmission (Primary 1)](https://blocklist.configserver.dev/transmission/blocklist.ipset) | A large blocklist for the BitTorrent client [Transmission](https://transmissionbt.com/) | ★★★★★    | [view](https://blocklist.configserver.dev/transmission/blocklist.ipset) | [view](https://transmissionbt.com/) |
...
| Set                                                                                                                    | Description                                                                                                                                                                                                                                                       | Severity | View                                                                                            |
|------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------|-------------------------------------------------------------------------------------------------|
| [Akamai Core Networks](https://blocklist.configserver.dev/geolite/asn/A/akamai_core.ipset)                             | Global content delivery, edge acceleration, caching, and distributed web infrastructure operated by Akamai. Commonly used for CDN delivery, enterprise applications, APIs, and website performance optimization.                                                  | ★⚝⚝⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/A/akamai_core.ipset)                      |
| [Akamai Linode Networks](https://blocklist.configserver.dev/geolite/asn/A/akamai_linode.ipset)                         | Linode cloud hosting infrastructure operated by Akamai. Frequently used for VPS instances, development servers, automation services, VPNs, self-hosted applications, and customer-managed cloud workloads.                                                        | ★★★★⚝    | [view](https://blocklist.configserver.dev/geolite/asn/A/akamai_linode.ipset)                    |
| [Alibaba Cloud Networks](https://blocklist.configserver.dev/geolite/asn/A/alibaba.ipset)                               | Cloud computing and hosting infrastructure operated by Alibaba Cloud, including VPS hosting, enterprise services, web applications, and globally distributed cloud platforms.                                                                                     | ★★★★⚝    | [view](https://blocklist.configserver.dev/geolite/asn/A/alibaba.ipset)                          |
| [Amazon Core Networks](https://blocklist.configserver.dev/geolite/asn/A/amazon_core.ipset)                             | Amazon corporate and internal infrastructure supporting retail platforms, operational services, logistics systems, and enterprise network operations outside standard AWS customer environments.                                                                  | ★⚝⚝⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/A/amazon_core.ipset)                      |
| [Amazon Cloudfront](https://blocklist.configserver.dev/geolite/asn/A/amazon_cloudfront.ipset)                          | Global content delivery network (CDN) and edge caching infrastructure operated by Amazon CloudFront, commonly used for website acceleration, media streaming, API delivery, and distributed content distribution.                                                 | ★⚝⚝⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/A/amazon_cloudfront.ipset)                |
| [Apple Networks](https://blocklist.configserver.dev/geolite/asn/A/apple_inc.ipset)                                     | Apple infrastructure supporting iCloud, software updates, device services, APIs, push notifications, and connectivity used across Apple hardware and online platforms.                                                                                            | ★⚝⚝⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/A/apple_inc.ipset)                        |
| [AT&T Networks](https://blocklist.configserver.dev/geolite/asn/A/att.ipset)                                            | Telecommunications and internet infrastructure operated by AT&T, including consumer broadband, wireless carrier services, enterprise networking, and ISP backbone operations.                                                                                     | ★★⚝⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/A/att.ipset)                              |
| [Automattic Networks](https://blocklist.configserver.dev/geolite/asn/A/automattic.ipset)                               | Infrastructure used by Automattic services including WordPress.com, WooCommerce, Jetpack, Gravatar, and related hosting or content delivery platforms.                                                                                                            | ★★⚝⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/A/automattic.ipset)                       |
| [Baidu Networks](https://blocklist.configserver.dev/geolite/asn/B/baidu.ipset)                                         | Infrastructure operated by Baidu, including search services, cloud platforms, content delivery systems, AI services, and supporting internet infrastructure. Commonly observed in automated traffic and large-scale scanning activity in global threat telemetry. | ★★★★⚝    | [view](https://blocklist.configserver.dev/geolite/asn/B/baidu.ipset)                            |
| [Bluehost / EIG Networks](https://blocklist.configserver.dev/geolite/asn/B/bluehost_eig.ipset)                         | Hosting infrastructure associated with Bluehost and Endurance International Group (EIG), including shared hosting environments, VPS platforms, customer web hosting services, and managed website infrastructure.                                                 | ★★★★⚝    | [view](https://blocklist.configserver.dev/geolite/asn/B/bluehost_eig.ipset)                     |
| [BunnyCDN Networks](https://blocklist.configserver.dev/geolite/asn/B/bunnycdn.ipset)                                   | Global content delivery and edge caching infrastructure operated by BunnyCDN, commonly used for website acceleration, media delivery, API distribution, and static asset caching.                                                                                 | ★⚝⚝⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/B/bunnycdn.ipset)                         |
| [Cablevision Networks](https://blocklist.configserver.dev/geolite/asn/C/cablevision.ipset)                             | Regional ISP infrastructure providing consumer broadband and enterprise connectivity services. Typically used by residential users with limited hosting or abusive surface area.                                                                                  | ★★⚝⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/C/cablevision.ipset)                      |
| [Censys Networks](https://blocklist.configserver.dev/geolite/asn/C/censys_io.ipset)                                    | Internet-wide scanning and security research infrastructure used for large-scale asset discovery, enumeration, and security telemetry collection across global networks.                                                                                          | ★★★★⚝    | [view](https://blocklist.configserver.dev/geolite/asn/C/censys_io.ipset)                        |
| [Charter / Spectrum Networks](https://blocklist.configserver.dev/geolite/asn/C/charter_spectrum_timewarnercable.ipset) | Major consumer ISP infrastructure providing broadband and cable internet services across residential and business customers.                                                                                                                                      | ★★⚝⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/C/charter_spectrum_timewarnercable.ipset) |
| [ChinaNet Networks](https://blocklist.configserver.dev/geolite/asn/C/china_chinanet.ipset)                             | Large backbone ISP infrastructure operated in China, supporting residential and enterprise internet traffic at national scale.                                                                                                                                    | ★★★⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/C/china_chinanet.ipset)                   |
| [China Mobile Networks](https://blocklist.configserver.dev/geolite/asn/C/china_mobile.ipset)                           | Mobile carrier and ISP infrastructure providing cellular and broadband connectivity across China with large-scale consumer traffic.                                                                                                                               | ★★★⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/C/china_mobile.ipset)                     |
| [China Net Mobile Networks](https://blocklist.configserver.dev/geolite/asn/C/china_net_mobile.ipset)                   | Mobile and broadband network infrastructure associated with Chinese telecommunications providers, serving large-scale consumer connectivity.                                                                                                                      | ★★★⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/C/china_net_mobile.ipset)                 |
| [China National Networks](https://blocklist.configserver.dev/geolite/asn/C/china_networks.ipset)                       | Aggregated Chinese national telecom and ISP infrastructure covering multiple backbone and regional providers.                                                                                                                                                     | ★★★⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/C/china_networks.ipset)                   |
| [China Telecom Networks](https://blocklist.configserver.dev/geolite/asn/C/china_telecom.ipset)                         | Major Chinese telecommunications backbone provider supporting national internet infrastructure, enterprise services, and consumer broadband.                                                                                                                      | ★★★⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/C/china_telecom.ipset)                    |
| [China Tencent Cloud Networks](https://blocklist.configserver.dev/geolite/asn/C/china_tencent_net.ipset)               | Cloud computing and digital infrastructure operated by Tencent, including hosting, gaming infrastructure, APIs, and distributed cloud services.                                                                                                                   | ★★★★⚝    | [view](https://blocklist.configserver.dev/geolite/asn/C/china_tencent_net.ipset)                |
| [China Tietong Networks](https://blocklist.configserver.dev/geolite/asn/C/china_tietong.ipset)                         | Regional Chinese telecommunications provider supporting broadband and backbone connectivity services across multiple regions.                                                                                                                                     | ★★★⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/C/china_tietong.ipset)                    |
| [China Unicom Networks](https://blocklist.configserver.dev/geolite/asn/C/china_unicorn.ipset)                          | Major Chinese telecom operator providing mobile, broadband, and enterprise networking services nationwide.                                                                                                                                                        | ★★★⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/C/china_unicorn.ipset)                    |
| [Cloudflare Networks](https://blocklist.configserver.dev/geolite/asn/C/cloudflare.ipset)                               | Global content delivery network, reverse proxy, and security infrastructure used for web acceleration, DDoS protection, DNS services, and API routing.                                                                                                            | ★⚝⚝⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/C/cloudflare.ipset)                       |
| [Comcast Networks](https://blocklist.configserver.dev/geolite/asn/C/comcast.ipset)                                     | Large consumer ISP infrastructure providing residential and business broadband, cable, and enterprise connectivity services in North America.                                                                                                                     | ★★⚝⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/C/comcast.ipset)                          |
| [Contabo Hosting Networks](https://blocklist.configserver.dev/geolite/asn/C/contabo_gmbh.ipset)                        | Low-cost VPS and dedicated hosting infrastructure commonly used for self-hosted applications, automation, VPNs, and general-purpose cloud workloads.                                                                                                              | ★★★★⚝    | [view](https://blocklist.configserver.dev/geolite/asn/C/contabo_gmbh.ipset)                     |
| [Cox Communications Networks](https://blocklist.configserver.dev/geolite/asn/C/cox_communications.ipset)               | Consumer ISP infrastructure providing broadband internet, cable services, and enterprise networking solutions in the United States.                                                                                                                               | ★★⚝⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/C/cox_communications.ipset)               |
| [DigitalOcean Networks](https://blocklist.configserver.dev/geolite/asn/D/digital_ocean.ipset)                          | Cloud hosting infrastructure providing VPS instances, developer servers, APIs, and self-hosted applications. Frequently used for automation, bots, and ephemeral workloads.                                                                                       | ★★★★⚝    | [view](https://blocklist.configserver.dev/geolite/asn/D/digital_ocean.ipset)                    |
| [DreamHost Networks](https://blocklist.configserver.dev/geolite/asn/D/dreamhost.ipset)                                 | Shared and VPS hosting provider supporting websites, blogs, and small-scale web applications.                                                                                                                                                                     | ★★★⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/D/dreamhost.ipset)                        |
| [Embarq Networks](https://blocklist.configserver.dev/geolite/asn/E/embarq.ipset)                                       | Legacy telecommunications and regional ISP infrastructure providing residential internet connectivity services.                                                                                                                                                   | ★★⚝⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/E/embarq.ipset)                           |
| [Facebook (Meta) Networks](https://blocklist.configserver.dev/geolite/asn/F/facebook.ipset)                            | Global infrastructure operated by Meta, including social platforms, APIs, CDN systems, and backend services for Facebook, Instagram, and related services.                                                                                                        | ★⚝⚝⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/F/facebook.ipset)                         |
| [Fastly Networks](https://blocklist.configserver.dev/geolite/asn/F/fastly.ipset)                                       | High-performance edge cloud and CDN infrastructure used for content delivery, API acceleration, and security services.                                                                                                                                            | ★⚝⚝⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/F/fastly.ipset)                           |
| [FDC Servers Networks](https://blocklist.configserver.dev/geolite/asn/F/fdc_servers.ipset)                             | Low-cost dedicated server and hosting provider frequently used for bulk hosting, proxy services, and high-abuse server workloads.                                                                                                                                 | ★★★★★    | [view](https://blocklist.configserver.dev/geolite/asn/F/fdc_servers.ipset)                      |
| [Frontier Communications Networks](https://blocklist.configserver.dev/geolite/asn/F/frontier_communications.ipset)     | Consumer ISP infrastructure providing broadband internet and telecom services across residential and business customers.                                                                                                                                          | ★★⚝⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/F/frontier_communications.ipset)          |
| [GitHub Networks](https://blocklist.configserver.dev/geolite/asn/G/github_inc.ipset)                                   | Developer infrastructure supporting code hosting, CI/CD pipelines, APIs, and software distribution platforms.                                                                                                                                                     | ★⚝⚝⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/G/github_inc.ipset)                       |
| [GoDaddy Networks](https://blocklist.configserver.dev/geolite/asn/G/godaddy.ipset)                                     | Domain registrar and shared hosting provider supporting website hosting, DNS services, and small business infrastructure.                                                                                                                                         | ★★★⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/G/godaddy.ipset)                          |
| [Google Networks](https://blocklist.configserver.dev/geolite/asn/G/google.ipset)                                       | Global infrastructure supporting search, cloud computing (GCP), APIs, and large-scale consumer and enterprise services.                                                                                                                                           | ★⚝⚝⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/G/google.ipset)                           |
| [HAProxy Technologies Networks](https://blocklist.configserver.dev/geolite/asn/H/haproxy_technologies_inc.ipset)       | Infrastructure associated with load balancing, reverse proxy, and traffic routing systems used in enterprise and cloud environments.                                                                                                                              | ★⚝⚝⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/H/haproxy_technologies_inc.ipset)         |
| [Hetzner Networks](https://blocklist.configserver.dev/geolite/asn/H/hetzner.ipset)                                     | European low-cost dedicated server and cloud hosting provider widely used for VPS hosting, automation, VPNs, and scalable workloads.                                                                                                                              | ★★★★★    | [view](https://blocklist.configserver.dev/geolite/asn/H/hetzner.ipset)                          |
| [Hostinger Networks](https://blocklist.configserver.dev/geolite/asn/H/hostinger.ipset)                                 | Shared and VPS hosting provider used for small to medium websites, web applications, and general hosting services.                                                                                                                                                | ★★★⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/H/hostinger.ipset)                        |
| [InMotion Hosting Networks](https://blocklist.configserver.dev/geolite/asn/I/inmotion_hosting.ipset)                   | Web hosting provider offering shared hosting, VPS, and managed hosting services for websites and business applications.                                                                                                                                           | ★★★⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/I/inmotion_hosting.ipset)                 |
| [Internet Measurement Networks](https://blocklist.configserver.dev/geolite/asn/I/internet_measurement_com.ipset)       | Research and scanning infrastructure used for internet-wide measurement, telemetry collection, and security analysis.                                                                                                                                             | ★★★★⚝    | [view](https://blocklist.configserver.dev/geolite/asn/I/internet_measurement_com.ipset)         |
| [IONOS / 1&1 Networks](https://blocklist.configserver.dev/geolite/asn/I/ionos_1and1.ipset)                             | European hosting and cloud provider offering VPS, shared hosting, and enterprise infrastructure services.                                                                                                                                                         | ★★★⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/I/ionos_1and1.ipset)                      |
| [Korea Telecom Networks](https://blocklist.configserver.dev/geolite/asn/K/korea_telecom.ipset)                         | Major national telecommunications provider in South Korea offering broadband, mobile, and enterprise networking services.                                                                                                                                         | ★★⚝⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/K/korea_telecom.ipset)                    |
| [Microsoft Networks](https://blocklist.configserver.dev/geolite/asn/M/microsoft_corp.ipset)                            | Global infrastructure supporting Azure cloud services, enterprise platforms, APIs, and Microsoft consumer services.                                                                                                                                             | ★⚝⚝⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/M/microsoft_corp.ipset)                   |
| [Namecheap Networks](https://blocklist.configserver.dev/geolite/asn/N/namecheap.ipset)                                 | Domain registrar and hosting provider offering shared hosting, DNS services, and basic VPS infrastructure.                                                                                                                                                        | ★★★⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/N/namecheap.ipset)                        |
| [Nintendo Networks](https://blocklist.configserver.dev/geolite/asn/N/nintendo.ipset)                                   | Gaming infrastructure supporting online multiplayer services, game authentication, and digital distribution for Nintendo platforms.                                                                                                                               | ★⚝⚝⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/N/nintendo.ipset)                         |
| [Onyphe Intelligence Networks](https://blocklist.configserver.dev/geolite/asn/O/onyphe_io.ipset)                       | Cyber intelligence and internet scanning infrastructure used for threat detection, asset discovery, and security research.                                                                                                                                        | ★★★★⚝    | [view](https://blocklist.configserver.dev/geolite/asn/O/onyphe_io.ipset)                        |
| [Oracle Cloud Networks](https://blocklist.configserver.dev/geolite/asn/O/oracle.ipset)                                 | Global cloud computing infrastructure providing enterprise hosting, databases, APIs, and large-scale application deployment services.                                                                                                                             | ★★★★⚝    | [view](https://blocklist.configserver.dev/geolite/asn/O/oracle.ipset)                           |
| [OVHcloud Networks](https://blocklist.configserver.dev/geolite/asn/O/ovh_cloud.ipset)                                  | European cloud and dedicated server provider widely used for VPS hosting, game servers, VPN infrastructure, and automation workloads.                                                                                                                             | ★★★★★    | [view](https://blocklist.configserver.dev/geolite/asn/O/ovh_cloud.ipset)                        |
| [Psychz Networks](https://blocklist.configserver.dev/geolite/asn/P/psychz_networks.ipset)                              | Dedicated server and hosting provider often associated with high-bandwidth hosting, proxy infrastructure, and bulk server deployments.                                                                                                                            | ★★★★★    | [view](https://blocklist.configserver.dev/geolite/asn/P/psychz_networks.ipset)                  |
| [QuadraNet Networks](https://blocklist.configserver.dev/geolite/asn/Q/quadra_net.ipset)                                | Data center and colocation provider offering dedicated servers, hosting infrastructure, and enterprise network services.                                                                                                                                          | ★★★★⚝    | [view](https://blocklist.configserver.dev/geolite/asn/Q/quadra_net.ipset)                       |
| [Qwest / CenturyLink Networks](https://blocklist.configserver.dev/geolite/asn/Q/qwest_centurylink.ipset)               | Large telecommunications and ISP backbone provider delivering residential and enterprise internet connectivity across the United States.                                                                                                                          | ★★⚝⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/Q/qwest_centurylink.ipset)                |
| [Rackspace Hosting Networks](https://blocklist.configserver.dev/geolite/asn/R/rackspace_hosting.ipset)                 | Managed cloud hosting provider supporting enterprise applications, email systems, and hybrid cloud infrastructure.                                                                                                                                                | ★★★⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/R/rackspace_hosting.ipset)                |
| [Recyber Networks](https://blocklist.configserver.dev/geolite/asn/R/recyber_net.ipset)                                 | Hosting and network infrastructure associated with security-focused and mixed-use internet services, often appearing in scanning and proxy traffic.                                                                                                               | ★★★★⚝    | [view](https://blocklist.configserver.dev/geolite/asn/R/recyber_net.ipset)                      |
| [Russia: Crimea South LLC Networks](https://blocklist.configserver.dev/geolite/asn/R/russia_crimeacom_south_llc.ipset) | Regional ISP and hosting infrastructure operating within Russian-controlled network regions, often observed in high-risk or poorly regulated traffic sources.                                                                                                     | ★★★★★    | [view](https://blocklist.configserver.dev/geolite/asn/R/russia_crimeacom_south_llc.ipset)       |
| [Russia: Zummer LLC Networks](https://blocklist.configserver.dev/geolite/asn/R/russia_zummer_llc.ipset)                | Russian hosting and network provider associated with regional internet infrastructure and mixed-use hosting environments.                                                                                                                                         | ★★★★★    | [view](https://blocklist.configserver.dev/geolite/asn/R/russia_zummer_llc.ipset)                |
| [Scaleway Networks](https://blocklist.configserver.dev/geolite/asn/S/scaleway_sas.ipset)                               | European cloud provider offering VPS, bare-metal servers, and scalable hosting infrastructure commonly used for automation and application hosting.                                                                                                               | ★★★★⚝    | [view](https://blocklist.configserver.dev/geolite/asn/S/scaleway_sas.ipset)                     |
| [Servers.com Networks](https://blocklist.configserver.dev/geolite/asn/S/servers_dot_com_inc.ipset)                     | Global dedicated server provider offering high-performance hosting, VPS infrastructure, and enterprise-grade compute resources.                                                                                                                                   | ★★★★⚝    | [view](https://blocklist.configserver.dev/geolite/asn/S/servers_dot_com_inc.ipset)              |
| [Shadowserver Foundation Networks](https://blocklist.configserver.dev/geolite/asn/S/shadowserver_foundation.ipset)     | Internet security research organization performing global scanning, threat intelligence gathering, and vulnerability monitoring.                                                                                                                                  | ★★★★⚝    | [view](https://blocklist.configserver.dev/geolite/asn/S/shadowserver_foundation.ipset)          |
| [SharkTech Networks](https://blocklist.configserver.dev/geolite/asn/S/sharktech.ipset)                                 | Hosting provider known for DDoS-protected servers, VPN hosting, and high-abuse infrastructure usage in global threat datasets.                                                                                                                                    | ★★★★★    | [view](https://blocklist.configserver.dev/geolite/asn/S/sharktech.ipset)                        |
| [Shodan Internet Intelligence Networks](https://blocklist.configserver.dev/geolite/asn/S/shodan_io.ipset)              | Internet-wide scanning and search engine infrastructure used for asset discovery, security research, and exposure indexing.                                                                                                                                       | ★★★★★    | [view](https://blocklist.configserver.dev/geolite/asn/S/shodan_io.ipset)                        |
| [Starlink Networks](https://blocklist.configserver.dev/geolite/asn/S/spacex_starlink.ipset)                            | Satellite internet infrastructure operated by SpaceX providing global broadband connectivity via low-Earth orbit satellites.                                                                                                                                      | ★★⚝⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/S/spacex_starlink.ipset)                  |
| [Sprint Networks](https://blocklist.configserver.dev/geolite/asn/S/sprint.ipset)                                       | Telecommunications provider offering mobile, broadband, and enterprise connectivity services across the United States.                                                                                                                                            | ★★⚝⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/S/sprint.ipset)                           |
| [StackPath / Blackhost Networks](https://blocklist.configserver.dev/geolite/asn/S/stackpath_blackhost.ipset)           | Edge computing and hosting infrastructure providing CDN, security, and distributed application delivery services.                                                                                                                                                 | ★★★⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/S/stackpath_blackhost.ipset)              |
| [TikTok (ByteDance) Networks](https://blocklist.configserver.dev/geolite/asn/T/tiktok_bytedance.ipset)                 | Global infrastructure supporting TikTok and ByteDance services including video delivery, APIs, and content distribution systems.                                                                                                                                  | ★⚝⚝⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/T/tiktok_bytedance.ipset)                 |
| [X (Twitter) Networks](https://blocklist.configserver.dev/geolite/asn/T/twitter_x.ipset)                               | Social media infrastructure supporting X platform services including APIs, media delivery, and real-time communication systems.                                                                                                                                   | ★⚝⚝⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/T/twitter_x.ipset)                        |
| [UpCloud Networks](https://blocklist.configserver.dev/geolite/asn/U/upcloud_usa_inc.ipset)                             | High-performance cloud hosting provider offering VPS infrastructure, low-latency compute, and scalable application hosting.                                                                                                                                       | ★★★★⚝    | [view](https://blocklist.configserver.dev/geolite/asn/U/upcloud_usa_inc.ipset)                  |
| [US Department of Defense Networks](https://blocklist.configserver.dev/geolite/asn/U/department_of_defense_dnic.ipset) | Government-controlled defense and intelligence network infrastructure used for military, research, and secure communications systems.                                                                                                                             | ★⚝⚝⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/U/department_of_defense_dnic.ipset)       |
| [US Internet Corp Networks](https://blocklist.configserver.dev/geolite/asn/U/usa_internet_corp.ipset)                  | Regional ISP and internet service provider offering broadband connectivity and network services within the United States.                                                                                                                                         | ★★⚝⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/U/usa_internet_corp.ipset)                |
| [Verizon Networks](https://blocklist.configserver.dev/geolite/asn/V/verizon.ipset)                                     | Major telecommunications provider delivering mobile, broadband, and enterprise networking infrastructure across the United States.                                                                                                                                | ★★⚝⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/V/verizon.ipset)                          |
| [Viettel Networks](https://blocklist.configserver.dev/geolite/asn/V/vietel.ipset)                                      | Large telecommunications provider operating mobile, broadband, and enterprise networking services in Vietnam and international markets.                                                                                                                           | ★★⚝⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/V/vietel.ipset)                           |
| [Vultr Networks](https://blocklist.configserver.dev/geolite/asn/V/vultr.ipset)                                         | Cloud infrastructure provider offering VPS hosting, bare-metal servers, and globally distributed compute resources frequently used for automation and deployments.                                                                                                | ★★★★★    | [view](https://blocklist.configserver.dev/geolite/asn/V/vultr.ipset)                            |
| [Yahoo Networks](https://blocklist.configserver.dev/geolite/asn/Y/yahoo.ipset)                                         | Internet services infrastructure supporting Yahoo Mail, search, content delivery, and legacy web services.                                                                                                                                                        | ★⚝⚝⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/Y/yahoo.ipset)                            |
| [YouTube (Google) Networks](https://blocklist.configserver.dev/geolite/asn/Y/youtube.ipset)                            | Video streaming infrastructure operated by Google providing global content delivery, APIs, and media processing systems.                                                                                                                                          | ★⚝⚝⚝⚝    | [view](https://blocklist.configserver.dev/geolite/asn/Y/youtube.ipset)                          |
...
| [Emerging Threats](https://blocklist.configserver.dev/3rdparty/emergingthreats/compromised.ipset)                     | Threat intelligence feed identifying compromised systems and infected hosts observed participating in malicious activity, malware communication, botnet operations, or unauthorized network behavior. | `★★★★⚝`  | [view](https://blocklist.configserver.dev/3rdparty/emergingthreats/compromised.ipset) |
...
| [FireHOL BotScout Global Bot List](https://blocklist.configserver.dev/3rdparty/firehol/botscout.ipset)                | Database of known spam bots and automated systems used for account abuse and form submission attacks.                                                                       | `★★★★⚝`  | [view](https://blocklist.configserver.dev/3rdparty/firehol/botscout.ipset)                |
| [FireHOL BotScout Recent Bots (1 Day)](https://blocklist.configserver.dev/3rdparty/firehol/botscout_1d.ipset)         | Recently detected bot activity involved in automated spam and abuse attempts.                                                                                               | `★★★★⚝`  | [view](https://blocklist.configserver.dev/3rdparty/firehol/botscout_1d.ipset)             |
| [FireHOL BotScout Extended Bots (30 Day)](https://blocklist.configserver.dev/3rdparty/firehol/botscout_30d.ipset)     | Longer-term bot activity aggregation capturing persistent automated abuse sources.                                                                                          | `★★★★⚝`  | [view](https://blocklist.configserver.dev/3rdparty/firehol/botscout_30d.ipset)            |
| [FireHOL BotScout Weekly Bots](https://blocklist.configserver.dev/3rdparty/firehol/botscout_7d.ipset)                 | Short-term aggregation of bot activity used for spam, scraping, and automated attacks.                                                                                      | `★★★★⚝`  | [view](https://blocklist.configserver.dev/3rdparty/firehol/botscout_7d.ipset)             |
...
| [FireHOL DShield Recent Attacks (1 Day)](https://blocklist.configserver.dev/3rdparty/firehol/dshield_1d.ipset)        | Latest detected malicious scanning and attack activity from distributed sensors.                                                                                            | `★★★★⚝`  | [view](https://blocklist.configserver.dev/3rdparty/firehol/dshield_1d.ipset)              |
| [FireHOL DShield Extended Attacks (30 Day)](https://blocklist.configserver.dev/3rdparty/firehol/dshield_30d.ipset)    | Long-term aggregation of attack sources identified across global monitoring systems.                                                                                        | `★★★★⚝`  | [view](https://blocklist.configserver.dev/3rdparty/firehol/dshield_30d.ipset)             |
| [FireHOL DShield Weekly Attacks](https://blocklist.configserver.dev/3rdparty/firehol/dshield_7d.ipset)                | Short-term attack aggregation identifying recent scanning and intrusion attempts.                                                                                           | `★★★★⚝`  | [view](https://blocklist.configserver.dev/3rdparty/firehol/dshield_7d.ipset)              |
| [FireHOL GreenSnow Abuse Feed](https://blocklist.configserver.dev/3rdparty/firehol/greensnow.ipset)                   | Community-driven list of malicious IPs involved in scanning, brute-force, and exploitation activity.                                                                        | `★★★★⚝`  | [view](https://blocklist.configserver.dev/3rdparty/firehol/greensnow.ipset)               |
...
| [Multiduplikator Core](https://blocklist.configserver.dev/3rdparty/multiduplikator/blocklist_core.ipset)              | Pre-aggregated blocklists optimized for MikroTik routers. <br><sub><sup>List includes [Tor Exit Nodes](https://github.com/SecOps-Institute/Tor-IP-Addresses), [Spamhaus DROP](https://www.spamhaus.org/drop/), [SSL Blacklist](https://sslbl.abuse.ch/), [Blocklist.de](https://lists.blocklist.de/), [Feodo Tracker](https://feodotracker.abuse.ch/), [FireHOL Level 1](https://iplists.firehol.org/), [IPsum Level 3](https://github.com/stamparm/ipsum)</sup></sub> | `★★★★⚝`  | [view](https://blocklist.configserver.dev/3rdparty/multiduplikator/blocklist_core.ipset)  |
| [Multiduplikator Large](https://blocklist.configserver.dev/3rdparty/multiduplikator/blocklist_large.ipset)            | Pre-aggregated blocklists optimized for MikroTik routers. Contains Core list + CINS Army. <br><sub><sup>List includes [Tor Exit Nodes](https://github.com/SecOps-Institute/Tor-IP-Addresses), [Spamhaus DROP](https://www.spamhaus.org/drop/), [SSL Blacklist](https://sslbl.abuse.ch/), [Blocklist.de](https://lists.blocklist.de/), [Feodo Tracker](https://feodotracker.abuse.ch/), [FireHOL Level 1](https://iplists.firehol.org/), [IPsum Level 3](https://github.com/stamparm/ipsum), [CINS Army](https://cinsscore.com/)</sup></sub> | `★★★⚝⚝`  | [view](https://blocklist.configserver.dev/3rdparty/multiduplikator/blocklist_large.ipset)  |
| [Multiduplikator Extra Large](https://blocklist.configserver.dev/3rdparty/multiduplikator/blocklist_extralarge.ipset) | Pre-aggregated blocklists optimized for MikroTik routers. Contains Core list + Large list + IPsum L1. <br><sub><sup>List includes [Tor Exit Nodes](https://github.com/SecOps-Institute/Tor-IP-Addresses), [Spamhaus DROP](https://www.spamhaus.org/drop/), [SSL Blacklist](https://sslbl.abuse.ch/), [Blocklist.de](https://lists.blocklist.de/), [Feodo Tracker](https://feodotracker.abuse.ch/), [FireHOL Level 1](https://iplists.firehol.org/), [IPsum Level 3](https://github.com/stamparm/ipsum), [CINS Army](https://cinsscore.com/), [IPsum Level 1](https://github.com/stamparm/ipsum)</sup></sub> | `★★⚝⚝⚝`  | [view](https://blocklist.configserver.dev/3rdparty/multiduplikator/blocklist_extralarge.ipset)  |
