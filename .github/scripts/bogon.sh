...
#   @path               .github/scripts/bogon.sh
#   @args               .github/scripts/bogon.sh
#                           <argFileSaveTo>     str         required
#   @commands           1.  CFG_SKIP_CIDR_DEDUPE=true ./.github/scripts/bogon.sh blocklists/bogon.ipset
#                       2.  CFG_STDOUT=true CFG_SKIP_CIDR_DEDUPE=true ./.github/scripts/bogon.sh blocklists/bogon.ipset
#   @structure          📁 .github
#                           📁 scripts
#                               📄 bogon.sh
#                           📁 templates
...
{
    echo "list_fallback_download placeholder"
}
...
list_fallback_load()
{
    echo "list_fallback_load placeholder"
}
...
list_main_load()
{
    ...
    prinp "📄[-1] Generating BOGON IP list #${_fnListNum}"
...
EOF
    ...
    unset   _fnArgFile _fnListNum _fnFileTemp \
